...
var callApiButton = document.querySelector('#call-api');
...
function log() {
  ...
  p.innerText = parts.map(function (part) {
...
(function () {
  ...
  buttons.hidden = false; // Only initialize msal if window is not callback (not popup).
